                ...
                customMenu.map((menu, menuIndex) => {
                    ...
                    return (
                        <div key={`menu-index-${menuIndex}`}>
                            ...
                            >
                                {descriptor.name}
                                {activeMenu === id?<MinusIcon className={classes.plusIcon} />:<PlusIcon className={classes.plusIcon} />}
                                <span className={`${classes.itemsCount} ${activeMenu === id?classes.isActiveMenu:""}`}>{items.length}</span>
                            </Typography>
                            {
                                activeMenu === id && (
                                    <>
                                                    ...
                                                    <>
                                                        {
                                                            items.map((item, itemInd) => (
                                                                <Typography
                                                                    ...
                                                                    onClick={() => {
                                                                        history.push(`/application/products/${item.id}`)
                                                                    }}
                                                                >
