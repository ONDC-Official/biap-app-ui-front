  ...
  return (
    <>
      <div className='flex mb-3'>
        <input
          className="px-4 py-1.5 w-full border border-gray-300 rounded-md  hover:border-primary focus:outline-primary"
          placeholder='Key'
          name='keyItem'
          onChange={(e) => handleOnChange(e)}
        />
        <input
          className="ml-3 px-4 py-1.5 w-full border border-gray-300 rounded-md hover:border-primary focus:outline-primary"
          placeholder='Value'
          name='valueItem'
          onChange={(e) => handleOnChange(e)}
        />
