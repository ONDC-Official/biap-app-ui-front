...
const StepTwoLabel = ({activeStep, onUpdateActiveStep}) => {
                    ...
                    <div className={classes.addressLabelTypo}>
                        <Grid container spacing={3}>
                            <Grid item xs={12} sm={12} md={4} lg={4} xl={4}>
                                <Typography className={classes.addressHeaderTypo} component="div" variant="body">
                                    Billing Address
                                </Typography>
                                <Typography className={classes.addressTextTypo} component="div" variant="body">
                                    {billingAddress.name}
                                </Typography>
                                <Typography className={classes.addressTextTypo} component="div" variant="body">
