        ...
        <Box className={classes.homeContainer}>
            <Grid container spacing={3}>
                <Grid item xs={12} sm={12} md={4} lg={4} xl={4}>
                    <Grid container spacing={3}>
                        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                            <Card className={classes.fashionCategory}>
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                            <Card className={classes.electronicsCategory}>
                ...
                <Grid item xs={12} sm={12} md={4} lg={4} xl={4}>
                    <Grid container spacing={3}>
                        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                            <Card className={classes.groceryCategory}>
                                <Grid container spacing={0}>
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                            <Grid container spacing={3}>
                                <Grid item xs={12} sm={12} md={6} lg={6} xl={6} style={{height: '100%'}}>
                                    <Card className={classes.foodCategory}>
                                ...
                                <Grid item xs={12} sm={12} md={6} lg={6} xl={6} style={{height: '100%'}}>
                                    <Card className={classes.healthCategory}>
                ...
                <Grid item xs={12} sm={12} md={4} lg={4} xl={4}>
                    <Grid container spacing={3}>
                        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                            <Card className={classes.homeCategory}>
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                            <Card className={classes.bpcCategory}>
                                <Grid container spacing={0}>
